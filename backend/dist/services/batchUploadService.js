...
async function processPairedFiles(problemId, pairedFiles, readFileFunc, log) {
    ...
    for (const key of sortedKeys) {
        ...
        if (pair && pair.in && pair.out) {
            ...
            await db.query('INSERT INTO testcases (problem_id, case_number, input_data, output_data) VALUES ($1, $2, $3, $4)', [problemId, caseCounter, inputData.toString('utf-8'), outputData.toString('utf-8')]);
            caseCounter++;
        }
    }
...
//# sourceMappingURL=batchUploadService.js.map