...
const db = require('../../db');
const { migrateSubmissionsAfterContest } = require('../../services/problemMigration');
...
describe('Contest Scheduler Service', () => {
    beforeEach(() => {
        ...
        contestScheduler.isRunning = false;
        contestScheduler.checkInterval = null;
    });
    ...
    describe('start / stop', () => {
        ...
        it('should stop the scheduler', () => {
            contestScheduler.start();
            const mockStop = contestScheduler.checkInterval.stop;
    ...
    describe('checkContestStatus', () => {
        ...
        it('should end running contests, trigger migration, and mark finishing', async () => {
            ...
            migrateSubmissionsAfterContest.mockResolvedValueOnce({});
        ...
        it('should still mark contest as finished if migration fails', async () => {
            ...
            migrateSubmissionsAfterContest.mockRejectedValueOnce(error);
