...
const problemRouter = require('../controllers/problemController');
const db = require('../db');
...
jest.mock('../middleware/upload', () => ({
    diskUpload: { single: () => (req, res, next) => next() },
    memoryUpload: { fields: () => (req, res, next) => next() }
}));
...
describe('Problem Controller', () => {
    ...
    describe('GET /problems', () => {
        it('should return a list of visible problems', async () => {
            ...
            db.query.mockResolvedValueOnce({ rows: mockProblems });
    ...
    describe('GET /problems/:id', () => {
        it('should return problem details if visible', async () => {
            ...
            db.query.mockResolvedValueOnce({ rows: [mockProblem] });
    ...
    describe('POST /admin/problems', () => {
        it('should create a new problem successfully', async () => {
            ...
            db.query.mockResolvedValueOnce({ rows: [newProblem] });
