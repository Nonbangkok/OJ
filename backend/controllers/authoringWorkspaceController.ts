...
router.get('/admin/authoring/drafts/:id/jobs', requireAuth, requireStaffOrAdmin,
...
router.get('/admin/authoring/drafts/:id/assets/:assetId', requireAuth, requireStaffOrAdmin,
