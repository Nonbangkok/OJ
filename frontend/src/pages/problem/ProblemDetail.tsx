...
const ProblemDetail: React.FC = () => {
  ...
  if (!problem || !problemId) return <div className={styles['error-message']}>Problem not found.</div>;
      ...
      case 'submit':
        return (
          <div className={styles['submit-view']}>
            <CodeSubmissionForm problemId={problemId} {...(contestId && { contestId: String(contestId) })} />
          </div>
        );
      case 'submissions':
        ...
        return (
          <div className={styles['submissions-wrapper']}>
            <Submissions problemId={problemId} contestId={contestId as any} showTitle={false} />
          </div>
        );
      default:
        return null;
