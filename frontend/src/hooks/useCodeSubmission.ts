...
import type { CodeSubmission, ProgrammingLanguage } from '../types';
...
const useCodeSubmission = (problemId: string | number, contestId?: string | number): UseCodeSubmissionReturn => {
    ...
    const handleSubmit = async (e: FormEvent): Promise<void> => {
        ...
        try {
            const submitData: CodeSubmission = {
                problemId,
                language,
                code,
            };
