...
interface ProblemMigrationModalProps {
  contest: Contest;
  onClose: () => void;
  onSuccess: () => void;
}

const ProblemMigrationModal = ({ contest, onClose, onSuccess }: ProblemMigrationModalProps) => {
  const {
    availableProblems,
    contestProblems,
    loading,
        ...
        <div className={modalStyles.migrationModalGrid}>
          ...
          <div className={modalStyles.migrationControls}>
            <div className={modalStyles.migrationControlsButtons}>
              ...
              <button
                onClick={() => handleMoveToMain(undefined)}
