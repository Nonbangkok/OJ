...
const SubmissionModal: React.FC<SubmissionModalProps> = ({ submission, onClose }) => {
  const {
    copySuccess,
    code,
    lineCount,
        ...
        <div className={styles['top-bar']}>
          ...
          <div className={styles['submission-detail']}>
            <div className={styles['detail-row']}>
              ...
              <span className={styles['detail-value']}>{formatDate(submission.submittedAt)}</span>
            </div>
            <div className={styles['detail-row']}>
            ...
            <div className={styles['detail-row']}>
              ...
              <span className={`${styles['detail-value']} ${getStatusClass(submission.status)}`}>
                {submission.status}
              </span>
            </div>
            <div className={styles['detail-row']}>
